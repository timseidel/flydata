...
# Hint: left_join(planes) to get plane year, left_join(airlines) for carrier name
# Hint: mutate(plane_age = 2023 - year) to calculate age
# Hint: group_by(plane_age, carrier) + summarize(n() for flights, n_distinct(tailnum) for planes)
